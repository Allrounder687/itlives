...
pub fn throw_random_desktop_icon() -> Result<(), String> {
    ...
    use windows::Win32::UI::WindowsAndMessaging::{FindWindowExW, SendMessageW, GetSystemMetrics, SM_CXSCREEN, SM_CYSCREEN};
    ...
    unsafe {
        ...
        SendMessageW(listview_hwnd, LVM_SETITEMPOSITION, WPARAM(random_index as usize), LPARAM(lparam as isize));
    }
